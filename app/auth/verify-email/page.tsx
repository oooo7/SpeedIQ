  ...
  if (verificationStatus === 'success') {
    return (
      <div className="mx-auto flex w-full flex-col justify-center space-y-8 sm:w-[380px] px-4">
        <Card className="bg-white dark:bg-gray-900">
          <CardContent className="pt-8 pb-8 space-y-4 text-center">
            <div className="mx-auto w-16 h-16 bg-green-100 dark:bg-green-900 flex items-center justify-center">
        ...
        <Card className="bg-white dark:bg-gray-900">
          <CardContent className="pt-8 pb-8 space-y-6">
            <div className="space-y-4 text-center">
              <div className="mx-auto w-16 h-16 bg-red-100 dark:bg-red-900 flex items-center justify-center">
